...
class FeatureCentry extends AbstractCentry{
  ...
  /**
   * Constructor de la clase feature que se puede instanciar con el id de prestashop, el id de centry o ambos
  ...
  public static function createTable() {
      ...
      ALTER TABLE  `" . _DB_PREFIX_ . "feature_centry"."` ADD UNIQUE INDEX `id_centry` (`id_centry`) ;
