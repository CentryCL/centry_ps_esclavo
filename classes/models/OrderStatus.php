...
class OrderStatusCentry extends AbstractCentry
{
    ...
    public static function createTable() {
      ...
      ALTER TABLE  " . _DB_PREFIX_ . "orders_centry"." ADD UNIQUE INDEX (`id`) ;
      ALTER TABLE `" . _DB_PREFIX_ . "orders_centry"."` ADD FOREIGN KEY (`id`) REFERENCES `" . _DB_PREFIX_ . "order_state"."`(`id_order_state`) ON DELETE CASCADE ON UPDATE NO ACTION;
      ";
