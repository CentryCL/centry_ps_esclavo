...
class VariantCentry extends AbstractCentry{
  ...
  /**
   * Constructor de la clase variante que se puede instanciar con el id de prestashop, el id de centry o ambos
  ...
  /**
   * Creación de la tabla para la homologación de variantes donde el id y el id_centry deben ser unicos.
  ...
  public static function createTable() {
      ...
      ALTER TABLE  `" . _DB_PREFIX_ . "variant_centry"."` ADD UNIQUE INDEX `id` (`id`) ;
      ALTER TABLE  `" . _DB_PREFIX_ . "variant_centry"."` ADD UNIQUE INDEX `id_centry` (`id_centry`) ;
